...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-foreground">Wise Shopper</span>
            </Link>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              Wise Shopper empowers shoppers to make informed purchasing decisions through real-time price
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-foreground text-center mb-12">Why Choose Wise Shopper?</h2>
